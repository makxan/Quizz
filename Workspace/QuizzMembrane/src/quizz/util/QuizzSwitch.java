 ...
 * @generated
 */
public class QuizzSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case QuizzPackage.QUESTION: {
				...
				if (result == null) result = caseDestinationTerminal(question);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QuizzPackage.MULTIPLE_CHOICE: {
				...
				if (result == null) result = caseDestinationTerminal(multipleChoice);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QuizzPackage.FREE_TEXT: {
				...
				if (result == null) result = caseDestinationTerminal(freeText);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case QuizzPackage.ENDPOINT: {
				...
				if (result == null) result = caseDestinationTerminal(endpoint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case QuizzPackage.SCORECOUNTER: {
				Scorecounter scorecounter = (Scorecounter)theEObject;
				T result = caseScorecounter(scorecounter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QuizzPackage.DESTINATION_TERMINAL: {
				DestinationTerminal destinationTerminal = (DestinationTerminal)theEObject;
				T result = caseDestinationTerminal(destinationTerminal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Startpoint</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Startpoint</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Scorecounter</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Scorecounter</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseScorecounter(Scorecounter object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Destination Terminal</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Destination Terminal</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDestinationTerminal(DestinationTerminal object) {
		return null;
	}
