 ...
 * @generated
 */
public class StartpointItemSemanticEditPolicy extends
		QuizzBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public StartpointItemSemanticEditPolicy() {
		super(QuizzElementTypes.MultipleChoice_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (QuizzVisualIDRegistry.getVisualID(outgoingLink) == AnswerEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
			...
			if (QuizzVisualIDRegistry.getVisualID(outgoingLink) == StartpointNextEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
