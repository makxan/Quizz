 ...
 * @generated
 */
public class ScorecounterItemSemanticEditPolicy extends
		QuizzBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ScorecounterItemSemanticEditPolicy() {
		super(QuizzElementTypes.Startpoint_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (QuizzVisualIDRegistry.getVisualID(outgoingLink) == QuestionNextEditPart.VISUAL_ID) {
