 ...
 * @generated
 */
public class StartpointNextReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public StartpointNextReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof DestinationTerminal && newEnd instanceof Question)) {
			return false;
		}
		return QuizzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistQuestionNext_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return QuizzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistQuestionNext_4002(getOldSource(), getNewTarget());
	}
