 ...
 * @generated
 */
public class FreeTextTitleEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FreeTextTitleEditPart(View view) {
		super(view);
	}
			...
			parser = QuizzParserProvider
					.getParser(
							...
							QuizzVisualIDRegistry
									.getType(quizz.diagram.edit.parts.FreeTextTitleEditPart.VISUAL_ID));
		}
		return parser;
	}
