...
import quizz.diagram.edit.policies.MultipleChoiceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MultipleChoiceEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public MultipleChoiceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MultipleChoiceItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		org.eclipse.gmf.runtime.diagram.ui.editpolicies.LayoutEditPolicy lep = new org.eclipse.gmf.runtime.diagram.ui.editpolicies.LayoutEditPolicy() {
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				...
				switch (QuizzVisualIDRegistry.getVisualID(childView)) {
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof ScorecounterUsernameEditPart) {
