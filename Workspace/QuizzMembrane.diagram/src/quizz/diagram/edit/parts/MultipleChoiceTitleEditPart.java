...
import quizz.diagram.edit.policies.QuizzTextSelectionEditPolicy;
 ...
 * @generated
 */
public class MultipleChoiceTitleEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MultipleChoiceTitleEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new QuizzTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new QuizzEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return QuizzElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = QuizzParserProvider
					.getParser(
							QuizzElementTypes.MultipleChoice_2001,
							getParserElement(),
							QuizzVisualIDRegistry
									.getType(quizz.diagram.edit.parts.MultipleChoiceTitleEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					QuizzEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
