...
import quizz.diagram.edit.policies.EndpointItemSemanticEditPolicy;
import quizz.diagram.providers.QuizzElementTypes;

/**
 * @generated
 */
public class EndpointEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EndpointEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EndpointItemSemanticEditPolicy());
	...
	public class EndpointFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			WrappingLabel endpointLabel0 = new WrappingLabel();

			endpointLabel0.setText("Endpoint");

			this.add(endpointLabel0);
