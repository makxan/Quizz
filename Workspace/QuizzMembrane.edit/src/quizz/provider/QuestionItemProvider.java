		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QuizzPackage.Literals.QUESTION__ID,
				 true,
				 false,
				 false,
	...
	protected void addNextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Question_next_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Question_next_feature", "_UI_Question_type"),
				 QuizzPackage.Literals.QUESTION__NEXT,
				 true,
				 false,
				 true,
				 null,
